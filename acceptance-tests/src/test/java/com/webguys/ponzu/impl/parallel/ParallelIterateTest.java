...
import com.webguys.ponzu.impl.set.mutable.MultiReaderUnifiedSet;
...
public class ParallelIterateTest
{
    ...
    public void testSelect()
    {
        ...
        Collection<Integer> result = ParallelIterate.filter(collection, Predicates.greaterThan(10000));
    ...
    {
        Collection<Integer> collection = INTEGER_LIST;
        Collection<Integer> result = ParallelIterate.filter(collection, Predicates.greaterThan(10000), true);
        Verify.assertSize(10000, result);
        Verify.assertContains(20000, result);
        Verify.assertInstanceOf(List.class, result);
    }
    ...
    {
        Collection<Integer> collection = INTEGER_LIST;
        Collection<Integer> result = ParallelIterate.filterNot(collection, Predicates.greaterThan(10000));
        Verify.assertSize(10000, result);
    ...
    {
        Collection<Integer> collection = INTEGER_LIST;
        Collection<Integer> result = ParallelIterate.filterNot(collection, Predicates.greaterThan(10000), true);
        Verify.assertSize(10000, result);
        Verify.assertContains(1, result);
        Verify.assertInstanceOf(List.class, result);
    }
