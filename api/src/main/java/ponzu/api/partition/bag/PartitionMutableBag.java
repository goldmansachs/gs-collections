...
package ponzu.api.partition.bag;

import ponzu.api.bag.MutableBag;
import ponzu.api.partition.PartitionMutableCollection;

public interface PartitionMutableBag<T> extends PartitionMutableCollection<T>, PartitionBag<T>
{
    ...
    void addOccurrences(T each, int occurrences);
}
