...
public interface MapIterable<K, V> extends RichIterable<V>
{
    ...
    /**
     * For each key and value of the receiver the predicate is evaluated, if the result of the evaluation is true,
    ...
    /**
     * For each key and value of the receiver the function is evaluated.  The results of these evaluations are returned in
    ...
    /**
     * For each key and value of the receiver the predicate is evaluated, if the result of the evaluation is false,
     * that key and value are returned in a new map.
     * <p/>
     * <pre>e.g.
    ...
    /**
     * Return the first key and value of the receiver for which the predicate evaluates to true when they are given
     * as arguments. The predicate will only be evaluated until such pair is found or until all of the keys and
     * values of the map have been used as arguments. That is, there may be keys and values of the receiver that are
