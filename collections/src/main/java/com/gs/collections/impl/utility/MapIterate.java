 ...
 * <ul>
 * <li>do: -- iterate over all items</li>
...
public final class MapIterate
{
     ...
     * at the key, return the result of evaluating the specified {@link Function0}, and put that value in the
    ...
    /**
     * Return the value in the Map that corresponds to the specified key, or if there is no value at the key,
     * return the result of evaluating the specified {@link Function} with the <code>parameter</code>,
    ...
    /**
     * Return the value in the Map that corresponds to the specified key, or if there is no value
     * at the key, return the <code>defaultValue</code>.
     */
    ...
    /**
     * If there is a value in the Map that corresponds to the specified key,
     * return the result of applying the specified Function on the value,
    ...
    /**
     * For each value of the Map, predicate is evaluated with the value as the parameter.
     * Each value which causes predicate to evaluate to true is included in the new collection.
     */
    ...
    /**
     * For each value of the Map, predicate is evaluated with the value as the parameter.
     * Each value which causes predicate to evaluate to true is added to the targetCollection.
     */
    ...
    /**
     * Counts the number of values in the map for which predicate evaluates to true.
     */
    ...
    /**
     * For each value of the map, function is evaluated with the value as the parameter.
    ...
    /**
     * For each value in the map, apply the function, and add to the targetCollection.
     */
    ...
    /**
     * Return the first value of the map for which the predicate evaluates to true.
     * The result is <code>null</code> if predicate does not evaluate to true for any element,
     * or if the first element that predicate evaluates to true happens to be <code>null</code>.
     * The method stops iterating over the values when an element applied to predicate returns true.
     */
     ...
     * The result is <code>null</code> if predicate does not evaluate to true for any element,
     * or if the first element that predicate evaluates to true happens to be <code>null</code>.
     * If no element causes predicate to evaluate to true, answer the result of <code>ifNone</code> value.
     * The method stops iterating over the values when an element applied to predicate returns true.
     */
    ...
    /**
     * Return the final result of evaluating <code>function</code> using each value of the map and the
     * previous evaluation result as the parameters.
     * The first evaluation of operation is performed with injectValue as the first parameter, and
     * the first value of the map as the second parameter.
     * Subsequent evaluations are done with the result of the previous evaluation as the first parameter,
     * and the next value of the map as the second parameter.
    ...
    /**
     * Return true if the predicate evaluates to true for any element of the receiver.
     * Return false if the map is empty, or predicate never evaluates to true.
     */
    ...
    /**
     * Return true if the predicate evaluates to true for every value of the map.
