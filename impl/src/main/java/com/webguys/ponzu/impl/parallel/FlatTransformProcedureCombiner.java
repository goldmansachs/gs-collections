...
/**
 * Combines the results of a Collection of {@link com.webguys.ponzu.impl.block.procedure.FlatTransformProcedure}s which each hold onto a transformed (flatten) collection
 * of results.
 */
