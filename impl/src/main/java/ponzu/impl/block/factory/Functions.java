...
import ponzu.api.block.function.primitive.DoubleFunction;
import ponzu.api.block.function.primitive.IntFunction;
import ponzu.api.block.function.primitive.LongFunction;
import ponzu.api.block.predicate.Predicate;
import ponzu.api.block.procedure.ObjectIntProcedure;
import ponzu.api.block.procedure.Procedure;
import ponzu.api.block.procedure.Procedure2;
import ponzu.api.tuple.Pair;
import ponzu.impl.block.comparator.primitive.DoubleFunctionComparator;
import ponzu.impl.block.comparator.primitive.IntFunctionComparator;
import ponzu.impl.block.comparator.primitive.LongFunctionComparator;
import ponzu.impl.block.function.CaseFunction;
import ponzu.impl.block.function.IfFunction;
