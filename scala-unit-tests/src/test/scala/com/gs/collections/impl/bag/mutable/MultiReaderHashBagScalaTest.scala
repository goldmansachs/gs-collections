...
class MultiReaderHashBagScalaTest extends MultiReaderHashBagTestTrait
{
    ...
    @Test
    def toStringOfItemToCount_safe
    {
        this.assertWritersBlocked
        {
    ...
    @Test
    def forEachWithOccurrences_safe
    {
        this.assertWritersBlocked
        {
            this.classUnderTest.forEachWithOccurrences({
                (_: Int, _: Int) => ()
            })
        }
        this.assertReadersNotBlocked
    ...
    @Test
    def selectByOccurrences_safe
    {
        this.assertWritersBlocked
        {
            this.classUnderTest.selectByOccurrences({
                IntPredicates.isOdd
            })
        }
        this.assertReadersNotBlocked
