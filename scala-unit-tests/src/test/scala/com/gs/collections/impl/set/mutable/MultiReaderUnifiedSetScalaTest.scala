...
class MultiReaderUnifiedSetScalaTest extends MultiReaderUnifiedSetTestTrait
{
    ...
    @Test
    def newSetIterable_safe
    {
        this.assertWritersNotBlocked
        {
            MultiReaderUnifiedSet.newSet(FastList.newListWith(1, 2))
            ()
        }
        this.assertReadersNotBlocked
        {
    ...
    def union_safe
    {
        ...
        {
            this.classUnderTest.union(UnifiedSet.newSetWith(4, 5))
        }
        this.assertReadersNotBlocked
        {
            this.classUnderTest.union(UnifiedSet.newSetWith(4, 5))
    ...
    def unionInto_safe
    {
        this.assertWritersBlocked
        {
            this.classUnderTest.unionInto(UnifiedSet.newSetWith(4, 5), UnifiedSet.newSet[Int])
        }
        this.assertReadersNotBlocked
        {
            this.classUnderTest.unionInto(UnifiedSet.newSetWith(4, 5), UnifiedSet.newSet[Int])
    ...
    def intersect_safe
    {
        this.assertWritersBlocked
        {
            this.classUnderTest.intersect(UnifiedSet.newSetWith(3, 4))
        }
        this.assertReadersNotBlocked
        {
            this.classUnderTest.intersect(UnifiedSet.newSetWith(3, 4))
    ...
    @Test
    def intersectInto_safe
    {
        this.assertWritersBlocked
        {
            this.classUnderTest.intersectInto(UnifiedSet.newSetWith(3, 4), UnifiedSet.newSet[Int])
        }
        this.assertReadersNotBlocked
        {
            this.classUnderTest.intersectInto(UnifiedSet.newSetWith(3, 4), UnifiedSet.newSet[Int])
    ...
    def difference_safe
    {
        this.assertWritersBlocked
        {
            this.classUnderTest.difference(UnifiedSet.newSetWith(3, 4))
        }
        this.assertReadersNotBlocked
        {
            this.classUnderTest.difference(UnifiedSet.newSetWith(3, 4))
    ...
    @Test
    def differenceInto_safe
    {
        this.assertWritersBlocked
        {
            this.classUnderTest.differenceInto(UnifiedSet.newSetWith(3, 4), UnifiedSet.newSet[Int])
        }
        this.assertReadersNotBlocked
        {
            this.classUnderTest.differenceInto(UnifiedSet.newSetWith(3, 4), UnifiedSet.newSet[Int])
    ...
    @Test
    def symmetricDifference_safe
    {
        this.assertWritersBlocked
        {
            this.classUnderTest.symmetricDifference(UnifiedSet.newSetWith(3, 4))
        }
        this.assertReadersNotBlocked
        {
            this.classUnderTest.symmetricDifference(UnifiedSet.newSetWith(3, 4))
    ...
    @Test
    def symmetricDifferenceInto_safe
    {
        this.assertWritersBlocked
        {
            this.classUnderTest.symmetricDifferenceInto(UnifiedSet.newSetWith(3, 4), UnifiedSet.newSet[Int])
        }
        this.assertReadersNotBlocked
        {
            this.classUnderTest.symmetricDifferenceInto(UnifiedSet.newSetWith(3, 4), UnifiedSet.newSet[Int])
    ...
    def isSubsetOf_safe
    {
        this.assertWritersBlocked
        {
            this.classUnderTest.isSubsetOf(UnifiedSet.newSetWith(1, 2, 3, 4, 5))
        }
        this.assertReadersNotBlocked
        {
            this.classUnderTest.isSubsetOf(UnifiedSet.newSetWith(1, 2, 3, 4, 5))
    ...
    @Test
    def isProperSubsetOf_safe
    {
        this.assertWritersBlocked
        {
            this.classUnderTest.isProperSubsetOf(UnifiedSet.newSetWith(1, 2, 3, 4, 5))
        }
        this.assertReadersNotBlocked
        {
            this.classUnderTest.isProperSubsetOf(UnifiedSet.newSetWith(1, 2, 3, 4, 5))
    ...
    @Test
    def cartesianProduct_safe
    {
        this.assertWritersBlocked
        {
            this.classUnderTest.cartesianProduct(UnifiedSet.newSetWith(1, 2, 3, 4))
        }
        this.assertReadersNotBlocked
        {
            this.classUnderTest.cartesianProduct(UnifiedSet.newSetWith(1, 2, 3, 4))
