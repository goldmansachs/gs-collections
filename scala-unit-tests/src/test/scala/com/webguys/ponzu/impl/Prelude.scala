...
import com.webguys.ponzu.api.block.function.{Generator, Function, Function2, Function3}
import com.webguys.ponzu.api.block.predicate.{Predicate, Predicate2}
import com.webguys.ponzu.api.block.procedure.{ObjectIntProcedure, Procedure, Procedure2}
