...
public class BiMapsTest
{
    ...
    public void immutable()
    {
        ...
        Verify.assertInstanceOf(ImmutableMap.class, factory.ofAll(UnifiedMap.newMapWith(Tuples.pair(1, "2"), Tuples.pair(3, "4"), Tuples.pair(5, "6"), Tuples.pair(7, 8))));
        ...
        Verify.assertInstanceOf(ImmutableMap.class, factory.ofAll(Maps.immutable.ofAll(UnifiedMap.newMapWith(Tuples.pair(1, "2"), Tuples.pair(3, "4"), Tuples.pair(5, "6"), Tuples.pair(7, "8")))));
        ...
        Verify.assertInstanceOf(ImmutableMap.class, factory.ofAll(HashBiMap.newWithKeysValues(1, "2", 3, "4", 5, "6", 7, "8")));
        ...
        Verify.assertInstanceOf(ImmutableMap.class, factory.ofAll(map1));
        ...
        Verify.assertInstanceOf(ImmutableMap.class, factory.ofAll(map2.castToMap()));
        ImmutableBiMap<Integer, String> immutableMap1 = factory.ofAll(Maps.immutable.of(1, "2", 3, "4", 5, "6", 7, "8"));
        Assert.assertEquals(HashBiMap.newWithKeysValues(1, "2", 3, "4", 5, "6", 7, "8"), factory.ofAll(immutableMap1));
        Verify.assertInstanceOf(ImmutableMap.class, factory.ofAll(immutableMap1));
    }
    ...
    public void mutable()
    {
        ...
        Assert.assertEquals(HashBiMap.newMap(), factory.of());
        Verify.assertInstanceOf(MutableMap.class, factory.of());
        Assert.assertEquals(HashBiMap.newWithKeysValues(1, "2"), factory.of(1, "2"));
        Verify.assertInstanceOf(MutableMap.class, factory.of(1, "2"));
        Assert.assertEquals(HashBiMap.newWithKeysValues(1, "2", 3, "4"), factory.of(1, "2", 3, "4"));
        Verify.assertInstanceOf(MutableMap.class, factory.of(1, "2", 3, "4"));
        Assert.assertEquals(HashBiMap.newWithKeysValues(1, "2", 3, "4", 5, "6"), factory.of(1, "2", 3, "4", 5, "6"));
        Verify.assertInstanceOf(MutableMap.class, factory.of(1, "2", 3, "4", 5, "6"));
        Assert.assertEquals(HashBiMap.newWithKeysValues(1, "2", 3, "4", 5, "6", 7, "8"), factory.of(1, "2", 3, "4", 5, "6", 7, "8"));
        Verify.assertInstanceOf(MutableMap.class, factory.of(1, "2", 3, "4", 5, "6", 7, "8"));
    }
