...
public class CodePointAdapterTest extends AbstractImmutableIntListTestCase
{
    ...
    public void testEquals()
    {
        ...
        Assert.assertEquals(CodePointAdapter.adapt("あ\uD840\uDC00い\uD840\uDC03う\uD840\uDC06"), CodePointAdapter.adapt("あ\uD840\uDC00い\uD840\uDC03う\uD840\uDC06"));
        Assert.assertNotEquals(CodePointAdapter.adapt("あ\uD840\uDC00い\uD840\uDC03う"), CodePointAdapter.adapt("あ\uD840\uDC00い\uD840\uDC03う\uD840\uDC06"));
    ...
    public void collectCodePointUnicode()
    {
        Assert.assertEquals(
                ...
                CodePointAdapter.adapt("あ\uD840\uDC00い\uD840\uDC03う\uD840\uDC06").collect(i -> i));
        Assert.assertEquals(
                "あ\uD840\uDC00い\uD840\uDC03う\uD840\uDC06".codePoints().boxed().collect(Collectors.toList()),
                CodePointAdapter.adapt("あ\uD840\uDC00い\uD840\uDC03う\uD840\uDC06").collect(i -> i));
    }
    ...
    {
        String string = CodePointAdapter.adapt("あ\uD840\uDC00い\uD840\uDC03う\uD840\uDC06").select(Character::isBmpCodePoint).buildString();
    ...
    public void allSatisfyUnicode()
    {
        ...
        Assert.assertFalse(CodePointAdapter.adapt("\uD840\uDC00\uD840\uDC03\uD840\uDC06").allSatisfy(Character::isBmpCodePoint));
    }
    ...
    public void anySatisfyUnicode()
    {
        ...
        Assert.assertFalse(CodePointAdapter.adapt("\uD840\uDC00\uD840\uDC03\uD840\uDC06").anySatisfy(Character::isBmpCodePoint));
    }
    ...
    public void noneSatisfyUnicode()
    {
        ...
        Assert.assertTrue(CodePointAdapter.adapt("\uD840\uDC00\uD840\uDC03\uD840\uDC06").noneSatisfy(Character::isBmpCodePoint));
    }
    ...
    public void forEachUnicode()
    {
        ...
        CodePointAdapter.adapt("あ\uD840\uDC00い\uD840\uDC03う\uD840\uDC06").forEach(builder::appendCodePoint);
    ...
    {
        StringBuilder builder = new StringBuilder();
        CodePointAdapter.adapt("あ\uD840\uDC00い\uD840\uDC03う\uD840\uDC06").asReversed().forEach(builder::appendCodePoint);
    ...
    {
        StringBuilder builder = new StringBuilder();
        CodePointAdapter.adapt("あ\uD840\uDC00い\uD840\uDC03う\uD840\uDC06").toReversed().forEach(builder::appendCodePoint);
        Assert.assertEquals("\uD840\uDC06う\uD840\uDC03い\uD840\uDC00あ", builder.toString());
    ...
    public void distinctUnicode()
    {
        Assert.assertEquals(
                "\uD840\uDC00\uD840\uDC03\uD840\uDC06",
                CodePointAdapter.adapt("\uD840\uDC00\uD840\uDC03\uD840\uDC06\uD840\uDC00\uD840\uDC03\uD840\uDC06").distinct().buildString());
    }
